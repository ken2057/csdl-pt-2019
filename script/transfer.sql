...
insert into QLTV_Tram_3.qltv.dbo.NhanVien select * from NhanVien where ma_chinhanh = 'CT'
go
-- Insert TaiLieu
...
insert into QLTV_Tram_3.qltv.dbo.TaiLieu select ma_tailieu, tinhtrang, sl_kho from TaiLieu
go
-- Insert BanSao
