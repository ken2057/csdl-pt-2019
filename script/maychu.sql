...
go
Alter table [TaiLieu] add  foreign key([ma_tacgia_1]) references [TacGia] ([ma_tacgia])  on update no action on delete no action 
go
Alter table [TaiLieu] add  foreign key([ma_tacgia_2]) references [TacGia] ([ma_tacgia])  on update no action on delete no action 
go
Alter table [TaiLieu] add  foreign key([ma_tacgia_3]) references [TacGia] ([ma_tacgia])  on update no action on delete no action 
go
